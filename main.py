...
from LDA import LDA
from plots import rf_hyperparameters, oob_error_rf, Knn_hyperparameters, error_function_Knn, ideal_k
...
# For the scaled data for Knn:
    ...
    plt.plot(nvals, macro_f1_LDA, label= 'Macro average f1 score (LDA)')
    plt.plot(nvals, micro_f1_LDA, label= 'Micro average f1 score (LDA)')
    plt.xlabel('Train-test splits')
